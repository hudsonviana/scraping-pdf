...
function parseBill (pages) {
  ...
  // Declarative map of PDF data that we expect, based on Todd's structure
  const fields = {
    titular: { row: '5.587', index: 0 },
    vencimento: { row: '15.992999999999999', index: 1 },
    valorTotal: { row: '15.992999999999999', index: 0 },
    linhaDigitavel: { row: '31.409999999999997', index: 1 },
  };
